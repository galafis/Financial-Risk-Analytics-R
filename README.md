...
**Financial Risk Analytics R** — Professional repository showcasing advanced development skills

Total source lines: **223** across **1** files in **1** language.
...
Total de linhas de código: **223** em **1** arquivos em **1** linguagem.
